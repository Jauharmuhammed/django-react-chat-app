...
export function Chat() {
    ...
    return (
        <div className=" flex flex-col w-full justify-center min-h-screen items-center gap-5">
            <input
                name="name"
                placeholder="Name"
                onChange={handleChangeName}
                value={name}
                className="px-4 py-2 shadow-sm sm:text-sm border-gray-300 bg-gray-100 rounded-md"
            />
            <input
                name="message"
                placeholder="Message"
